...
async def search_poi(
    keywords: str = Query(..., description="搜索关键词", examples={"default": {"value": "故宫"}}),
    city: str = Query(..., description="城市", examples={"default": {"value": "北京"}}),
...
async def get_weather(
    city: str = Query(..., description="城市名称", examples={"default": {"value": "北京"}})
):
    """
    查询天气
